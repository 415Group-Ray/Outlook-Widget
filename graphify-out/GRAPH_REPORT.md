...
## Corpus Check
- 103 files · ~145,185 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1318 nodes · 3048 edges · 52 communities (49 shown, 3 thin omitted)
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 364 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9a60551d`
...
Cohesion: 0.06
Nodes (36): Queue, RefreshWork, Guid, JsonSerializerOptions, LeaseRecord, CancellationToken, Lock, long (+28 more)
...
### Community 27 - ".Locate"
Cohesion: 0.25
Nodes (6): Func, PackagedState, PackagedStateStatus, Fact, string, PackagedStateTests
...
### Community 29 - ".Record"
Cohesion: 0.05
Nodes (35): Mutex, byte, int, CacheCommitResult, CacheCommitStatus, CacheReadResult, CacheReadStatus, CurrentUserDataProtector (+27 more)

### Community 30 - "IOperationalLogger"
Cohesion: 0.07
Nodes (30): Count, Id, ImmutableArray, Outcome, AuthenticationOptions, DateTimeOffset, Guid, JsonSerializerOptions (+22 more)

### Community 31 - "SelectedAccountTests"
Cohesion: 0.08
Nodes (19): AccountId, IAccount, byte, Guid, JsonSerializerOptions, AccountRecord, SelectedAccountResult, SelectedAccountStore (+11 more)
...
### Community 41 - "CompanionLauncher"
Cohesion: 0.22
...
- **Why does `IOperationalLogger` connect `IOperationalLogger` to `AuthenticationOutcomeTests`, `.ReadAsync`, `.RefreshAsync`, `OutlookWidget.Core.Refresh`, `DisclosureTombstoneStore`, `.Start`, `ActiveRefreshTimer`, `WidgetInstanceRegistry`, `AuthenticationConfigurationTests`, `OutlookLauncher`, `DeliveryWorker`, `CompanionLauncher`, `SilentAuthProbe`, `WidgetProvider`, `.Record`, `SelectedAccountTests`?**
  _High betweenness centrality (0.110) - this node is a cross-community bridge._
- **Why does `OutlookWidget.Core.Refresh` connect `OutlookWidget.Core.Refresh` to `.RefreshAsync`, `DisclosureTombstoneStore`, `ActiveRefreshTimer`, `.Current`, `CoordinationStaticAnalysisTests`, `.Record`?**
  _High betweenness centrality (0.100) - this node is a cross-community bridge._
- **Why does `GraphMailClient` connect `.ReadAsync` to `.Start`, `OutlookWidget.Core.Refresh`, `IOperationalLogger`?**
