...
## Corpus Check
- 126 files · ~175,756 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1662 nodes · 3940 edges · 90 communities (84 shown, 6 thin omitted)
- Extraction: 87% EXTRACTED · 13% INFERRED · 0% AMBIGUOUS · INFERRED: 503 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a246b822`
...
### Community 11 - ".Record"
Cohesion: 0.26
Nodes (7): LockedWriteOutcome, TimeSpan, Func, LockedWriteOutcome, SettingsChangeCoordinator, SettingsChangeResult, WidgetSettings
...
### Community 17 - "ProtectedCache.cs"
Cohesion: 0.18
...
Cohesion: 0.18
Nodes (8): Mutex, bool, CancellationToken, int, MutationLock, MutationLockOutcome, MutationMutex, ThrowingCommitAction
...
### Community 74 - "WidgetInstanceRegistry"
Cohesion: 0.23
...
- **Why does `OutlookWidget.Core.Refresh` connect `OutlookWidget.Core.Refresh` to `.Current`, `DisclosureTombstoneStore`, `DeliveryWorker`, `CoordinationStaticAnalysisTests`, `SettingsChangeTests`, `ProtectedCache.cs`, `IOperationalLogger`, `.Raise`?**
  _High betweenness centrality (0.090) - this node is a cross-community bridge._
- **Why does `IOperationalLogger` connect `IOperationalLogger` to `.ReadAsync`, `.RefreshAsync`, `.Current`, `DisclosureTombstoneStore`, `ActiveRefreshTimer`, `.Record`, `AuthenticationConfigurationTests`, `SelectedAccountStore`, `ProtectedCache`, `CoordinationFixture`, `.AcquireAsync`, `CoordinationPaths`, `SilentAuthProbe`, `DeliveryWorker`, `MutationLock`, `OutlookLauncher`, `WidgetInstanceRegistry`, `CompanionLauncher`, `StateChangeListener`, `WidgetProvider`?**
